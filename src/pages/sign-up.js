        ...
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            ...
            <div className="flex flex-col w-2/5">
                ...
                <form onSubmit={handleSignup} method="POST">
                    <input aria-label="Enter your username" type="text" placeholder="Username" className="text-sm text-gray base w-full mr-3 py-5 px-4 h-2 border border-gray-primary round mb-2"
                    onChange={({target}) => setUsername(target.value)} 
                    value={username}/>

                    <input aria-label="Enter your full name" type="text" placeholder="Full Name" className="text-sm text-gray base w-full mr-3 py-5 px-4 h-2 border border-gray-primary round mb-2"
